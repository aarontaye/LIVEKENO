  ...
  return (
    <div className="rounded-xl border border-[rgba(232,169,59,0.12)] bg-[#0a0e17] p-4 sm:p-5">
      ...
      <div className="space-y-3">
        <button onClick={() => setConfirming('draft')} className="min-h-[44px] w-full rounded-lg border border-[rgba(232,169,59,0.3)] bg-transparent py-2.5 text-sm font-semibold text-[#e8a93b] hover:bg-[rgba(232,169,59,0.05)]">Save as Draft</button>
        <button onClick={() => setConfirming('publish')} className="min-h-[44px] w-full rounded-lg bg-gradient-to-r from-[#f0d680] to-[#a8842f] py-2.5 text-sm font-bold text-[#0a1628] hover:opacity-90">Publish Paytable</button>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={() => setConfirming(null)}>
          <div className="w-full max-w-sm rounded-xl border border-[rgba(232,169,59,0.2)] bg-[#0a0e17] p-5 sm:p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => fire(confirming)} className="min-h-[44px] flex-1 rounded-lg bg-gradient-to-r from-[#f0d680] to-[#a8842f] py-2 text-sm font-bold text-[#0a1628]">Confirm</button>
            </div>
          </div>
        </div>
      )}
